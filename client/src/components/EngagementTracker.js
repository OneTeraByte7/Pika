...
export default function EngagementTracker() {
    ...
    return (
        <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="text-sm text-gray-600 dark:text-gray-400">
                                        {platform.interactions} interactions
                                    </span>
            ...
            >
                <h3 className="text-xl font-bold mb-4">🎯 Retention Insights</h3>
                <div className="grid md:grid-cols-3 gap-4">
                    <div>
                        <p className="text-3xl font-bold">92%</p>
                        <p className="text-purple-100 text-sm">User Retention Rate</p>
                    </div>
                    <div>
                        <p className="text-3xl font-bold">4.2</p>
                        <p className="text-purple-100 text-sm">Avg. Engagement per User</p>
                    </div>
                    <div>
